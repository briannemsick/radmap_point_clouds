...
MAP_BUILDER.sparse_pose_graph.optimize_every_n_scans = 90
MAP_BUILDER.sparse_pose_graph.constraint_builder.sampling_ratio = 0.05
MAP_BUILDER.sparse_pose_graph.optimization_problem.ceres_solver_options.max_num_iterations = 10
-- The IMU is shitting the bed
...
MAP_BUILDER.sparse_pose_graph.constraint_builder.global_localization_min_score = 0.4
